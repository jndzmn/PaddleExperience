...
public class FXMLHomeController implements Initializable, Stoppable {
    ...
    @FXML
    private TextFlow button_logout;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        if (Estat.getMember() != null) {
            ...
            imPerfil.setStyle("-fx-border-width: 1px; -fx-border-radius: 3px; -fx-border-color: #78909C; -fx-border-fill: #78909C");
        }
    }
    ...
    @FXML
    private void on_click_logout(MouseEvent event) throws InterruptedException {
        
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION);
        alert.setContentText("Segur que vols tancar la sessió?");
        alert.setTitle("Tancaar sessió");
