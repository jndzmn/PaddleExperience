...
public class UserBooking {
    ...
    public UserBooking(Booking data, TableView table) {
        ...
        button_cancel.setStyle("-fx-text-fill: #FF5722;");
        
        button_cancel.setOnMouseClicked((Event event) -> this.on_click_pay(event));
        
        button_cancel.setEffect(new DropShadow(0.d, Color.valueOf("#78909C")));
        ...
        button_cancel.setOnMouseExited((event) -> {
        ...
        per_a_pagar.setStyle("-fx-text-fill: #ead880;");
        
        per_a_pagar.setEffect(new DropShadow(0.d, Color.valueOf("#78909C")));
        
        per_a_pagar.setOnMouseEntered((event) -> {
            ((DropShadow) ((Node) event.getSource()).getEffect()).setHeight(20);
            ((DropShadow) ((Node) event.getSource()).getEffect()).setWidth(20);
        });
        per_a_pagar.setOnMouseExited((event) -> {
            ((DropShadow) ((Node) event.getSource()).getEffect()).setHeight(0);
            ((DropShadow) ((Node) event.getSource()).getEffect()).setWidth(0);
        });
        ...
        if (data.getPaid()) {
            ...
            Text text_no = new Text("No");
            text_no.setStyle("-fx-fill: #FAFAFA;");
            this.pagada.getChildren().add(text_no);
        } else {
        ...
        //this.pagada.getChildren().get(0).setStyle("-fx-fill: #FF0000");
    ...
    public void refresh() {
        if (this.booking.getPaid()) {
            if (this.pagada_state != 0) {
                ...
                Text text_si = new Text("Sí");
                text_si.setStyle("-fx-fill: #FAFAFA;");
                this.pagada.getChildren().add(text_si);
            }
